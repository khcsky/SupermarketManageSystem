    ...
    <el-card class="box-card">
      ...
      <div class="text item">
        ...
        >
          ...
          <!-- 促销价元 -->
          <el-table-column prop="proprice" label="促销价(元)"></el-table-column>
          ...
          <!-- 库存总额(元) -->
          <el-table-column prop="repertoryall" label="库存总额(元)"></el-table-column>

          <!-- 销售总额(元) -->
          <el-table-column prop="saleall" label="销售总额(元)"></el-table-column>
